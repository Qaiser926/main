...
class ExpandedWidget extends StatelessWidget {
  ...
  static const double containerMargingTop = 10;
  static const double containerMargingBottom = 10;
  ...
  Widget build(BuildContext context) {
    var secHei = (subcategoryIds.length * singleExpandedHeight) +
        containerMargingBottom +
        containerMargingTop + bottomRowHeight;
                    ...
                    builder: (context, model, child) {
                      return Container(
                        margin: EdgeInsets.only(
                          bottom: containerMargingBottom,
                          top: containerMargingTop,
                          left: 10.h,
                          right: 10.h,
                        ),
                        child: Column(
  ...
  List<Widget> getSubcategoryExpandableContent(BuildContext context,
    ...
    result.add(Container(height: bottomRowHeight,
        child: Row(children: [Text("1"), Text("2")],)));

    return result;
  }

  List<Widget> getSubcategoryTextButtons(BuildContext context,
      SelectedSubcategoryNotifier model) {
            ...
            child: Row(
              children: [
                GestureDetector(
                  ...
                  onTap: () {
                    var categoryProvider = Provider.of<
                        SelectedSubcategoryNotifier>(
                        context,
                        listen: false);
