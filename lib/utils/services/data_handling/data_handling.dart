...
Image getPhotoNullSave({required String categoryId, required double width, required double height, String? photo}) {
  if (photo != null){
  return Image.memory(
    base64Decode(photo),
    width: width,
    ...
    return getAssetImage("${categoryId}.jpg", width: width, height: height) as Image;
  }
}
